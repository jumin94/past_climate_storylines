...
import os
import yaml
rootpath="/badc/cmip6/data/CMIP6"
...
with open("/home/users/tabu/past_climate_storylines/recipes/Amon_Omon_recipe_filled_datasets_ssp585_one_ens_member.yml", "w") as f:
